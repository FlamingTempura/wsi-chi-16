...
% wanted information presented in medical record - easier to reason about multiple case (used to a particular form), ordered to support diagnostic workflow (presenting complaint first, risk factor, social history), know where to look, refined over decades
...
%  - patient - sometimes it will be curiosity/obsession (e.g. they have just happen to have a device), or 
%  - patient - standard mechanisms of tracking illness, 
...
% Confirmation bias - interpret symptoms according to background
% Salient features; pattern recognition; illusory patterns
% Priming
% Prior experience
% not possible to measure specific presense, but some of the results are preliminary evidence
