...
The primary objective of doing a literature survey was to establish a theoretical framework from which we could start to understand the potential issues of introducing patient-logged data into medical decision making context.  We wished for this search to be broad enough to encompass technical, representational, human-factors-related issues, but also cultural, institutional, social and other factors that have influenced the use of data  as documented in the literature.  Furthermore, we wanted to cast a sufficiently broad 
