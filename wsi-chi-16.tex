...
To establish a theoretical framework from which to investigate potential problems with introducing patient-logged data into medical decision-making contexts, we performed a literature survey of topics related to medical decision-making.  We wished for this search to be broad enough to encompass technical, representational, human-factors-related issues pertaining to the introduction of data in the decision making process, but also cultural, institutional, social and other factors that have influenced its use. Since we wanted to focus on use by medical experts, we explicitly excluded studies about the use of information by patients, such as for reflection, goal setting and self monitoring, as well as the process of information capture by patients, except where aspects of capture affected its later use.  Since, however factors pertaining to the use of patient-related data in general may be particularly salient or problematic for the QS logged case, we included factors that might influence all use of patient data, including human factors issues of data interfaces, electronic medical records, and situational constraints of clinical settings, including operating theatres and emergency rooms.
