...
We anticipated that the slow uptake of the use of self-logged QS could potentially be attributed to a large number of factors, and thus decided it prudent to first do a survey of medical, quantified-self and HCI literature.  Our objective  was to establish a theoretical framework from which we could then identify areas that could require further investigation, as well as opportunities where research in HCI could substantially help.  We wished for this search to be broad enough to encompass all situations where patient-logged data (both paper and digital, manual and automatic) were introduced into a clinical setting,  in particular where problems were identified in the use of such data, whether such problems were  technical, human-factors related, social, cultural, institutional, situational, or of another sort altogether.

Since we wanted to focus on the usage of data by medical experts, we explicitly excluded studies about use by patients themselves, such as for feedback, reflection, goal setting and self monitoring.  Since we wished to focus on existing practice, we also omitted papers describing new interfaces and systems that have not had substantial adoption, as well as papers focused on the capture side of health diarising and life-logging by patients, except where aspects of capture affected its later use.  Since, however factors pertaining to the use of patient-related data in general may be particularly salient or problematic for the QS logged case, we included factors that might influence all use of patient data, including human factors issues of data interfaces, electronic medical records, and situational constraints of clinical settings, including operating theatres and emergency rooms.

\subsection{Review Method}

We started with MEDLINE, 
