...
Since these dimensions encompassed a broad set of possible factors, including data-oriented problems (such as pertaining to subject, quality and sampling), situational constraints, and practise constraints, we wished to understand which, if any, of these dimensions had support from previous studies.  This lead us a broad survey of medical literature, which we describe in the next section.  
...
This category pertains to how clinicians' training affects how effectively self-tracking data can be used, and the potential barriers to introducing self-tracking data to clinical practise. Three themes were identified in this category:
...
None of the participants had seen these scenarios in advance, and none knew in advance the true diagnoses—the man has a vitamin B12 deficiency, and the student was diagnosed with postural tachycardia syndrome.  We chose these scenarios because they are relatively complicated, such patients would be seen by both GPs and specialists, a diagnosis is not obvious, and they would provoke a chain of thoughts and judgements by the participants.

We distributed a scenario and a chart to the participants, and asked them to think out loud as they were reading them.  We then asked for general comments on the case, and how they would use the information supplied by the patient.  General practitioners were interviewed individually; specialists read and commented on the scenarios one-by-one in a group.  In addition, to overcome group influence, we asked specialists to jot down their thoughts on printed scenarios, and to hand them in at the end of the session.  Interviews lasted for about an hour with specialists, and about 3o minutes with GPs.  These were recorded and transcribed.
...
\bigquote{I observe the way they sit, or something else, or stomping gate, or something. You're eyes just think oh! and then your connection will be made consciously and unconsciously.}{GP1}
\end{quote}
...
\bigquote{I would try and ask a little bit more about this [referring to caffeine chart] and why she's done this anyway, just to have an understanding, of reasons, because not everyone charts their caffeine intake.}{GP3}

In particular, Sp3 suggested that the presentation of the caffeine chart was a way of indirectly telling him that there are underlying psychological issues, such as being overwhelmed and struggling with their studies, a job or a relationship. 

Referring to both scenarios, Sp5 asserted that the patient was obsessive to record  data, suggesting an underlying psychological issue. The mere existence of the heart rate plot provoked a similar jump to psychological issues with Sp4:
...
\bigquote{If all that are normal, and she's still feeling unwell, I would then refer back to that [pointing to the chart], especially if she's  a student and knowledgeable about that, might be cause to listen. \emph{Hang on. OK, tell me more about this, and why? Why are you doing that?}}{GP3}
...
\subsubsection{Deciding how to use the patient-provided data}

In deciding if patient-provided data should be used, Sp1 explained that they needed initially to make a decision on how much time on it

\bigquote{I mean I think when you look at something like this you do have to be able in your own mind to say,' OK am I going to spend 30 seconds on this, or am I really going to spend more time and give it more importance?'And I think that's what we face a lot.}{Sp1}
...
\bigquote{The layers of information, data assessment... It's ramping up and and  all of these devices are certainly adding or could and will add yet more of this... Certainly here we get a lot of things faxed to us. We get to know patients who come here and then they go somewhere else.  But then we are getting their lab work over and over again - their X-rays, their visits. At some point you have to ask yourself, \emph{what is efficient here and what is not?}}{Sp1}

Sp7 concurred, explaining that this adds "complexity to an already complex medical interface." Late in the discussion, there was general agreement within the room. Sp4 suggested that age of the clinician may be a large factor in acceptance of patient provided data arguing that medics are "creatures of habit," who do not usually change their practise significantly if their current work practise works for them.    Newly-trained young doctors may become used to patients bringing their own data. He foresaw not changing his own practise within the next 10 years.
...
\bigquote{But certainly, I don't think this [pointing to the chart] would influence me. The only influence it would have is to try and understand more about why he did this and what he wants out of the consultation.}{GP3}
...
\bigquote{I suppose I'm confident about what I've set in place is a safe plan, and I suppose that's the bit I need to be confident. And I suppose the other bit is no I'm not confident in what the diagnosis is yet, but I've got a working diagnosis,  I've got some queries in the background and time makes a big difference to what will happen. So I think there's a plan. Yeah I'm reasonably confident that the plan is reasonable. We've examined him. He's nothing obvious at the moment, I'll do an ECG, I'll do some blood tests, I'll see him again soon. He'll keep a note of what's going on. If something else happens in the meantime he'll shout. So I think that's safe. We're working through where we're going. I suppose I'm 90 per cent confident that that's a safe plan.}{GP2}

Another said,

\bigquote{So I'll try and keep him safe, and then try and reduce his risk from this condition.}{GP1}

\bigquote{I'm really just looking for things that are more serious, like trying to see what's the worst possible thing that she could have, approaching it that way. And hopefully it will turn out to be nothing. But I guess that's, usually, I'm always looking for what's the worst possible thing the person could have and work backwards from there... I'm trying] trying to approach it [the scenario] like we would in an office, really just looking for things that are more serious, like trying to see what's the worst possible thing that she could have, approaching it that way.}{Sp5}


In ruling out the worst cases, GP1 said that the knowledge of caffeine consumption changed his perspective on possible causes.  Although caffeine withdrawal may seem likely, there could be a far more serious tumor. One needs to construct a plan that is both economic--not to test for everything possible--and risk averse.  After reading a scenario and devising a plan, he says:

\bigquote{At the moment I've chopped chopped chopped chop, and we come to here. And now I think, \emph{Right, we've pruned off all of that, now I've got the bare tree. It's deciduous, not perennial.} And it's very easy to see, this is my path now. It's your heart, mate. And I need to do just one or two tests to show otherwise this tree... this root or trunk, becomes thicker and I will go that way. That's how I think.}{GP1}
...
In this section we interpret the themes resulting from our analysis into how future QS and self-diarising tools might be made to better support use in clinical diagnosis.
...
Somewhat unsurprisingly, we observed a critical relationship between the aforementioned process of risk-mitigation and the ways that clinical evidence was ordered, structured and represented. Our  secondary care specialists, in particular, expressed having to `re-arrange' information that was being presented to them in order for them to be able to effectively think about the evidence, and expressed frustration when trying to clearly understand how particular evidence fit within the frameworks to which they were accustomed.

Aspects that were deemed particularly crucial was the timeline of patient events.  Clinicians mentioned mentally placing evidence (corresponding to patient events) along this timeline as they went through the scenarios that they were give. Both chronological ordering and duration between events were important for identifying potential relationships between symptoms, and establishing connections between symptoms and potential causes.   Such relationships were germane to evidence admission; that is, for determining whether a particular piece of evidence was relevant for the current set of hypothesised causes.

During the process of restructuring evidence, several participants noticed that crucial information was missing from the scenario about the timeline of patient events.  This highlights an additional aspect of standardised representations, that they make it easier to identify when crucial information is missing.

Given the importance of the structuring and ordering in standard representations, we speculate whether digital tools might, where relevant, re-order and re-representing self-logged QS diary data into forms that clinicans are accustomed to.  If successful, such re-presentations could reduce the mental effort needed to transform presented evidence and facilitate reasoning, supporting external cognition~\cite{extcog} for the hypothesis refinement process.  Additionally, such representations might make it easier to spot irregularities in the evidence, such as missing data, errors or hidden causes.  Although not yet common in use even for clinical data, out evidence also suggests that visualisations of patient event timelines, if designed in a clinician-centric way, might facilitate temporal reasoning across related events.
...
\subsection{Psychology of Motivations for Self-Tracking} 
...
The design of this experiment had a number of limitations. First, the number of clinicians that we interviewed was small, with three GPs and 7 specialists. The practise of different clinicians may differ substantially depending on specialism, training, and where they work. Therefore our observations may not reflect the major differences in practise. Second, our interviews with GPs were conducted individually, whereas our interviews with specialists were conducted as a group. As a group, people may be more selective in what they say because of the presence of colleagues. Because of this, our observations cannot be used to contrast practises across primary and secondary care. Third, we presented the scenarios on paper, so the clinicians did not have access to the patient (or an actor) or their medical file. This is substantially different to their normal method of practise, where they would be able to interact with and examine the patient. This limits our ability to observe how self-logged data affects doctor-patient relationship. Fourth, we presented data on a piece of paper and not on a device, meaning we cannot infer the role of user interface. Finally, we only showed them two different forms of self-logged data, in two representations within two different scenarios. We cannot necessarily understand the implications of these findings in all applications of self-logged data.
...
This paper sought to investigate challenges to the adoption of self-tracked data in clinical practise. By conducting a review of literatature surrounding the use of self-logged data, we established that a number of barriers have been identified which pertain to data capture, data access, clinical practise and sitational constraints. By interviewing clinicians, we established that there exist a number of design opportunities to addressing these barriers. First, we observed that clinicians try to use information to support or rule out risky diseases, and that self-logged data was not always relavent to these early hypotheses. This presents challenges in how QS data can be design to facilitate \emph{discovery} (e.g. identifying potential causes not yet considered), and \emph{refinement} (e.g., eliminating hypothesis or supporting existing hypotheses).
