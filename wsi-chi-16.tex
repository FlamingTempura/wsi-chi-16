...
\def \w {\cellcolor{black!100}$\bullet$}
...
\begin{table*}
    ...
    %\def\arraystretch{0}
    \centering
    \begin{tabular}{>{\raggedright}p{4.3cm} !{\vrule width 1pt}
        p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} !{\vrule width 1pt}
        p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm} | p{0.6cm}}
        
    %\hline
    & \multicolumn{14}{>{\centering}p{8.4cm} !{\vrule width 1pt}}{Self-recorded data}
    & \multicolumn{8}{>{\centering}p{4.8cm}}{Other forms of data} \\ \hline
    ...
    & \cite{dontje_measuring_2015} \\ \hline
...
Reorganising information into a medical history
...
“I knew this wasn't a regular medical history. so right away I knew this was just like a New York Times case that you see in the times magazine, so it made me think this is like an oddball thing, it's not just a typical case, we're looking for oddball things, and so reading this, though, trying to approach it like we would in an office, really just looking for things that are more serious, like trying to see what's the worst possible thing that she could have, approaching it that way” S5
...
Evaluating the data quality and completeness
...
Deciding how to use the patient-provided data
...
Using (or ignoring) the patient-provided data
...
Pattern recognition, realising it might not be anything
...
Using patient-provided data to support risk averse workflow
