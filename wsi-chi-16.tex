...
\begin{itemize}
    ...
    % TODO!!! ‘relevance’ barrier being a mismatch between what is seen as important by the patient vs what is actually useful and “actionable” by a clinician
...
% TODO!!!  As a second example, under “Frameworks for Evidence: Form and Representation”, we will compare our findings regarding data representation and interpretability to those identified in the Literature Review (which included similar problems, such as heterogeneity and lack of representational standardisation). 
